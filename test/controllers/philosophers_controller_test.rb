...
class PhilosophersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create philosopher" do
    assert_difference("Philosopher.count") do
      post philosophers_url, params: { philosopher: { birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, fname: @philosopher.fname, lname: @philosopher.lname, short_bio: @philosopher.short_bio } }
    end
  ...
  test "should update philosopher" do
    patch philosopher_url(@philosopher), params: { philosopher: { birth_year: @philosopher.birth_year, death_year: @philosopher.death_year, fname: @philosopher.fname, lname: @philosopher.lname, short_bio: @philosopher.short_bio } }
